...
PROP_ROWS_X = (4450.0, 4500.0, 4700.0)
...
THROTTLE_GRIP_NARROW = 0.65
THROTTLE_GRIP_WIDE = 0.85
THROTTLE_DEADZONE = 0.45
...
SFX_ENABLED = False
SFX_MASTER_VOLUME = 0.7
SFX_ENGINE_VOLUME = 0.55
SFX_ENGINE_BASE_HZ = 58.0
SFX_ENGINE_RANGE = 0.95
SFX_GEARS = 5
SFX_SCREECH_STEER = 0.55